...
app.registerExtension({
    ...
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        // 调试：打印节点名称以便排查命名问题
        // 如果节点名称不匹配，请检查Python文件中的NODE_CLASS_MAPPINGS键名
        const nodeName = nodeData.name;
        if (nodeName && (nodeName.includes("MaskEditor") || nodeName.includes("mask_editor"))) {
            console.log("[MIKKY Mask Editor] Checking node:", nodeName, "Expected: MIKKYMaskEditorNode");
        }
        ...
        if (nodeName === "MIKKYMaskEditorNode") {
            ...
            nodeType.prototype.onNodeCreated = function () {
                ...
                this.setSize([500, 650]); // 稍微增加高度以容纳新按钮
                return r;
            };
